...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-lg-9 pos">
            <div>
                <?php
                $sql = "select * from course where topicText != ''";
                $res = mysqli_query($db , $sql);
                while ($r = mysqli_fetch_assoc($res)){
                    echo '<button class="collapsible">'.$r['title'].'</button> <div class="collapsible-content"> <p>' . str_replace("&nbsp;", " ", htmlspecialchars_decode(stripslashes($r['topicText']))) . '</p></div>';

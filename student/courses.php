...
if (isset($_SESSION['semail']) && !empty($_SESSION['semail'])) {
    ...
    if (!mysqli_connect_error()) {
        ...
        echo '<a href="mycourses.php" class="btn btn-info float-left" role="button">دروس من</a>';
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                echo "<tr class='clickable-row text-center' data-href='course.php?id=" . $row["courseId"] . "'>";

...
if (isset($_POST["submit"])) {
    ...
    if (!empty($title_unsafe) && !empty($description_unsafe)) {
        ...
        if (!mysqli_connect_error()) {
            ...
            $query = "insert into course (title,description,startDate,endDate,holdingDays,cost,capacity,quorum,topicText,topicFile ,topicFileName , brochureFileName ,brochureFile,teacherMail,isVirtual,qrCode) values
                            ('$title','$description',$startDate,$endDate,$holdingDays,$cost,$capacity,$quorum,$topictext,$titlePath,$titleName,$brochureName,$brochurePath,'".$_SESSION['temail']."' , $type , $qr)";

        ...
        init: function (options) {
            ...
            return this.each(function () {
                ...
                $this.popover({
                    ...
                    title: 'انتخاب تاریخ',
                    trigger: 'manual',
                    template: '<div class="popover" dir="ltr" role="tooltip"><div class="arrow"></div><h3 class="popover-title" data-name="Md-DateTimePicker-Title"></h3><div class="popover-content"  data-name="Md-DateTimePicker-PopoverContent"></div></div>',
